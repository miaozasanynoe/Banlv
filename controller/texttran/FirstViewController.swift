...
//        self.present(vc, animated: true, completion: nil)
    ...
    @IBAction func talktext_btn(_ sender: Any) {
        speakText(voiceOutdata: after_text.text!, lautype: speech_lau_date[tar]!)
    }
    ...
    @IBOutlet weak var talktext: UIButton!
    var tag:Int=0
    ...
    @IBAction func tran_btn_touch(_ sender: Any) {
        ...
        UIView.animate(withDuration: 0.5){
            self.talktext.alpha=0.8
            self.talktext.isEnabled=true
